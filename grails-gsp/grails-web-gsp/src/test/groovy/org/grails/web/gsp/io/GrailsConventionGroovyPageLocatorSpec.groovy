...
import org.apache.grails.core.plugins.filters.NoOpPluginFilter
...
class GrailsConventionGroovyPageLocatorSpec extends Specification {
    ...
    void "Test find view from binary plugin"() {
        ...
        def pageSource = pageLocator.findView(new TestController(), "binaryView")
...
'''
        ...
        def descriptor = new GrailsPluginDescriptor(resource, ['org.grails.web.gsp.io.TestBinaryGrailsPlugin'], ['org.grails.web.gsp.io.TestBinaryResource'])
        ...
        pluginManager.registerMockPlugin(binaryPlugin)
