...
To ensure compatibility with Grails 7.0.x, please review the following upgrade instructions carefully.
...
Grails 7.0.x adopts Groovy 4.0.30 as it's baseline requirement.
...
Grails 7.0.x is built on the Spring Framework, version 6.2.x. If your project uses Spring-specific features, refer to the https://github.com/spring-projects/spring-framework/wiki/Upgrading-to-Spring-Framework-6.x[Upgrading to Spring 6 guide].
...
Grails 6 used Spring Boot 2.7.x. Grails 7.0.x updates this to Spring Boot 3.5.x. For more information, consult the release notes for previous Spring Boot releases:
